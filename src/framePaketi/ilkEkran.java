...
public class ilkEkran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kaç Oyun Oynamak İstiyorsunuz ? ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String oyunSayisiStr= jTextField1.getText();
            int oyunSayisiInt = Integer.parseInt(oyunSayisiStr);
            turSecim tursec= new turSecim(oyunSayisiInt);
            setVisible(false);
            tursec.setVisible(true);
        } catch (Exception e) {
